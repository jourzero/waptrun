...
module.exports = {
    issue: {
        ...
        TSeverityText: {
            ...
            errorMessage: "Expected: severity text: Info , Low, Medium, High, Critical",
            trim: true,
        },
        IURIs: {
            optional: true,
        ...
        IPriorityText: {
            ...
            errorMessage: "Expected priority text: Info, Low, Medium, High, Critical, Tested, Fixed, TODO, Exclude",
            trim: true,
        },
        INotes: {
            optional: true,
