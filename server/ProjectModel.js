...
Projects.prototype.update = function(prjName, data, success, error) {
    ...
    //this.projects.findAndModify(project._id, { $set: { name: project.name } }, response(success, error));
    //this.projects.findOneAndUpdate({name:prjName}, data, response(success, error));
