...
function toHtml(objArray, prjName, prj, showAllIssues, includeMenu = true) {
    ...
    output +=
        "img{max-height:700px;max-width:700px;height:auto;width:auto;border:1px dashed DarkSlateBlue;}";
    ...
    // add pure-release-1.0.0/tables-min.js
    output +=
    ...
    for (let i = 0; i < objArray.length; i++) {
        ...
        if (obj.TTRef !== undefined && obj.TTRef !== "")
            output +=
                "<tr><td>Testing Ref.:</td><td><a href='" +
                obj.TTRef +
                "' target='refWin'>" +
                obj.TTRef +
                "</a></td></tr>\n";
        ...
        if (obj.IScreenshots !== undefined && obj.IScreenshots !== "")
            output += "<tr><td>Screenshot(s):</td><td>" + obj.IScreenshots + "</td></tr>\n";
